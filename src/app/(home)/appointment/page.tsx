            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-base">{selectedAppointmentData.doctorName}</h3>
                    <p className="text-sm text-gray-600">{selectedAppointmentData.specialty}</p>
                    <div className="flex items-center space-x-1 text-sm text-gray-500 mt-1">
                      <MapPin className="h-3 w-3" />
                      <span>{selectedAppointmentData.healthCenter}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-1 flex w-full justify-between items-center">
                    <div className="flex items-center space-x-2 text-sm text-gray-900">
                      ...
                      <span>{selectedAppointmentData.lastAppointmentDate}</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-gray-900">
                      <Clock className="h-4 w-4 text-gray-400" />
                      <span>{selectedAppointmentData.lastAppointmentTime}</span>
                    </div>
